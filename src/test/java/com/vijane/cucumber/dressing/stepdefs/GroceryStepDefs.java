...
public class GroceryStepDefs {
    ...
    public void iValidateTheProductsWillNotExpireAtLeastForTheNextDays(int minDaysUntilExpired) {
        ...
        TestScenario.getInstance()
                .getProducts()
                .forEach(product -> assertThat(
                        String.format("Product [%s] is going to expire earlier then the requested minimal of [%d] days until it should expire", product.getName(), minDaysUntilExpired),
